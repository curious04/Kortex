...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_CLfe8bUr.mjs';
import { manifest } from './manifest_B2GXXrdz.mjs';
...
const _args = {
    "middlewareSecret": "d3676ce0-25d1-4ead-bca7-8583a589d50f",
